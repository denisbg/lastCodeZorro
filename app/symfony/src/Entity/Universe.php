...
class Universe
{
     ...
     * @Groups({"read:universe:details","edit:universe","read:universe:imagehome"})
     */
    private $filenameimage1;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Groups({"read:universe:details","edit:universe","read:universe:imagehome"})
     */
    private $filenameimage2;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Groups({"read:universe:details","edit:universe","read:universe:imagehome"})
     */
    private $filenameimage3;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     * @Groups({"read:universe:details","edit:universe","read:universe:imagehome"})
     */
    private $filenameanatomie;

    /**
     * @ORM\Column(type="integer", nullable=true)
     * @Groups({"read:universe","edit:universe"}) 
     */
    private $anatomieactivated;

    /**
     * @ORM\Column(type="text", nullable=true)
     * @Groups({"read:universe:details","edit:universe","read:universe:bonusdetails"})
     */
    ...
    public function getFilenameimage1(): ?string
    {
        return $this->filenameimage1;
    }

    public function setFilenameimage1(?string $filenameimage1): self
    {
        $this->filenameimage1 = $filenameimage1;

        return $this;
    }

    public function getFilenameimage2(): ?string
    {
        return $this->filenameimage2;
    }

    public function setFilenameimage2(string $filenameimage2): self
    {
        $this->filenameimage2 = $filenameimage2;

        return $this;
    }

    public function getFilenameimage3(): ?string
    {
        return $this->filenameimage3;
    }

    public function setFilenameimage3(?string $filenameimage3): self
    {
        $this->filenameimage3 = $filenameimage3;

        return $this;
    }

    public function getFilenameanatomie(): ?string
    {
        return $this->filenameanatomie;
    }

    public function setFilenameanatomie(?string $filenameanatomie): self
    {
        $this->filenameanatomie = $filenameanatomie;

        return $this;
    }

    public function getAnatomieactivated(): ?int
    {
        return $this->anatomieactivated;
    }

    public function setAnatomieactivated(?int $anatomieactivated): self
    {
        $this->anatomieactivated = $anatomieactivated;

        return $this;
    }

    public function getBonusdetails(): ?string
    {
        return $this->bonusdetails;
    }

    public function setBonusdetails(?string $bonusdetails): self
    {
