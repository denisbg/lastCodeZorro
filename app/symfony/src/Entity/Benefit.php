 ...
 *              "normalization_context"={
 *                  "groups"={"read","read:benefit","read:benefit:user"}
 *               },
 *          },
 *          "get_benefit_details" = {
 *              "method" = "get",
...
class Benefit
{
     ...
     * @Groups({"read:benefit","read:command:benefit","edit:benefit:repairman","read:user:benefits"})
     */
    ...
    /**
     * @Groups({"read:benefit","read:command:benefit","read:user:benefits"}) 
     */
     ...
     * @Groups({"read:benefit:user","read:command:benefit","edit:benefit:repairman","read:service:benefits:user","read:user:benefits"})
     */
    private $benefitToDisplay = '1';
    ...
    public function getBenefitToDisplay(): ?string
    {
        return $this->benefitToDisplay;
    }

    public function setBenefitToDisplay(?string $benefitToDisplay): self
    {
        $this->benefitToDisplay = $benefitToDisplay;
