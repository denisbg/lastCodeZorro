...
export default function ArtisanListePrestations() {
  ...
  useEffect(() => {
    ...
    console.log("DB1 08:01 Affiche le repairman",currentRepairmanId );
    if (currentRepairmanId !== repairmanId) {
      // affiche la banner du repairman
      console.log("DB1 08:01A getrpairman (currentRepairmanId !== repairmanId)",currentRepairmanId );
