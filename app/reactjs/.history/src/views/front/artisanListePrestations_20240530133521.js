        ...
        if (refresh || cpParamsUrlService !== paramsUrlService) {
          ...
          connector({
            ...
            success: (response) => {
              ...
              console.log("DB1 11:05SUCCESS WEB SERVICES ", `${endPoints.ANONYMOUS_USER_REPAIRMAN}/${repairmanId}/benefits&itemsPerPage=5000&nbPage=10&categories.parent.universe.id=${parent_univ_id}` );
