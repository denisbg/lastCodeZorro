          ...
          connector({
            ...
            success: (response) => {
              ...
              Object.entries(response.data["hydra:member"]).forEach(entry => {
                ...
                console.log("DB1 12:10  parcours de la table service  ",service); 
                ...
                Object.entries(service).forEach(entry => {
                  ...
                  if (key === 'benefits') {
                    ...
                    Object.entries(prestations).forEach(entry => {
                      ...
                      console.log("DB1 12:12 traitement de la prestation looking for prestation repairmanBenefit", repairmanBenefit);
              ...
              console.log("DB1 12:11  liste des xPrestations ",xPrestations);
              console.log("DB1 12:13  liste des xServices ",xServices);
              console.log("DB1 12:14  total xServices ",xi);
