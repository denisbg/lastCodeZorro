            ...
            success: (response) => {
              ...
              Object.entries(response.data["hydra:member"]).forEach(entry => {
                ...
                Object.entries(service).forEach(entry => {
                  ...
                  xorg++;
                  console.log("DB1 12:121BUGG",xorg,service);
                      ...
                      Object.entries(repairmanBenefit).forEach(entry => {
                       ...
                       if (value['id'] === prestation['id']) {
                        console.log("DB1 12:122----------", xi,"trouvé",value);
                          ...
                          console.log("DB1 12:122 11:06SUCCESS PUSH service ",service);
                          console.log("DB1 12:122 11:06SUCCESSPUSH value ",value);
                          console.log("DB1 12:122 11:06SUCCESS ", "-------");
