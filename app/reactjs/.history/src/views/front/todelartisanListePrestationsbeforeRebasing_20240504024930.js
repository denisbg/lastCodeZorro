...
export default function ArtisanListePrestations() {
  ...
  useEffect(() => {
    // storing service clicet
    console.log("Data in fromServiceClick ", fromServiceClick);
          ...
          */
          ...
          connector({
            ...
            success: (response) => {
              ...
              console.log("ALP STEP 1.101 Prestation du reparateur loader repairmanbenefits is loaded.. ",repairmanId, repairmanBenefit);
          ...
          connector({
            ...
            success: (response) => {
              ...
              console.log("ALP STEP 1.151.00 extract all service of universe catalog", response);
              let xi = 0;
                    ...
                    Object.entries(prestations).forEach(entry => {
                      ...
                      Object.entries(repairmanBenefit).forEach(entry => {
                        ...
                        if (value['id'] === prestation['id']) {
                          console.log('ALP STEP 1.151.8A Benefit du repairman trouver pour ce service *******************', repairmanBenefit, prestations, service);
                          ...
                          connector({
                            method: "get",
                            url: `${endPoints.ANONYMOUS_BENEFITS_SERVICE}?service.id=${prestation['id']}`,
                            success: (response) => {
        
                              let results = response.data["hydra:member"] || [];
                              console.log("ALP STEP 1.151.8C ANONYMOUS_BENEFITS_SERVICE", results);
        ...
        <>
          <ContentPageStyle>
            <Container>
              ...
              />
              <BannerYourCommand
                serviceSelected={getBannerCommandStatus()}
                dataFromServiceClick={getDatafromServiceClick()}
